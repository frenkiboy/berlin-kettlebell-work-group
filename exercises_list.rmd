...
## two hand:
  ...
  ## one hand:
    ### flips:
      ...
      - front clock flip - kettlebell is parallel with player and flipped in front of body
        - similar to wheel flip, but arms are changed

      - lateral flip - front flip to the side
        - not perfected - returning kettlebell hits knee
